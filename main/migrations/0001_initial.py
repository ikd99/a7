# Generated by Django 3.2.7 on 2021-10-21 15:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_number', models.FloatField(default=1, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_evaluation', models.FloatField(null=True)),
                ('photo', models.ImageField(default='defo', upload_to='documents/')),
                ('md_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
